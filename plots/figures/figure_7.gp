...
plot "quantiles_with_ci_2" using 2:3 title "mean[quantile(theta given p*=0.3)]" w linespoints, \
	"" using 2:3:4:5 title "" w yerror, \
    ...
    "pstar=0.3_vs_nstar" using (0.075):2:3:4 title "mean[N* given p*=0.3]" w errorbars, \
